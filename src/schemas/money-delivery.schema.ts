...
export const moneyDeliveryCodeSchema = z.object({
  params: z.object({
    deliveryIdentifier: z.string()
      ...
      .regex(/^\d{10}[A-Z]\d+[A-Z]\d+$/, 'Invalid money delivery identifier format. Expected: codeFromRouteToRoute (e.g., 2401250001T1T2)')
      .trim()
  })
});

// Schema for money delivery code validation
export const moneyDeliveryCodeValidationSchema = z.string()
