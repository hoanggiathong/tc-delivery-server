...
describe('Debug Middleware', () => {
  ...
  it('should log incoming request and response', done => {
    ...
    // Execute
    debugMiddleware(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  it('should skip logging for webpack HMR requests', () => {
    ...
    // Execute
    debugMiddleware(hmrRequest as Request, mockResponse as Response, mockNext);
  ...
  it('should skip logging for hot-update requests', () => {
    ...
    // Execute
    debugMiddleware(hotUpdateRequest as Request, mockResponse as Response, mockNext);
  ...
  it('should handle POST request with different status code', done => {
    ...
    // Execute
    debugMiddleware(postRequest as Request, mockResponse as Response, mockNext);
  ...
  it('should handle requests with empty body and query', done => {
    ...
    // Verify request logging
    expect(mockedLogger.http).toHaveBeenCalledWith('GET /api/test - Body: {} - Query: {}');
  ...
  it('should measure response time accurately', done => {
    ...
    mockResponse.send = jest.fn().mockImplementation(function (this: Response, data?: any) {
      ...
      expect(mockedLogger.http).toHaveBeenCalledWith('GET /api/test - 200 - 150ms');
      done();
      return data;
    });
