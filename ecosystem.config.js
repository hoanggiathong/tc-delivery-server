...
module.exports = {
  apps: [
    ...
    {
      name: 'tc-delivery-news-publication-uat',
      version: APP_VERSION,
      script: 'dist/cronjob/process-news-publication.cronjob.js',
      cwd: './',
      instances: 1,
      exec_mode: 'fork',
      env: {
      ...
      env_file: '.env.uat',
      log_file: './logs/news-publication-uat-combined.log',
      out_file: './logs/news-publication-uat-out.log',
      error_file: './logs/news-publication-uat-error.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      watch: false,
      autorestart: true,
    ...
    {
      name: 'tc-delivery-account-deletion-uat',
      version: APP_VERSION,
      script: 'dist/cronjob/process-account-deletion.cronjob.js',
      cwd: './',
      instances: 1,
      exec_mode: 'fork',
      env: {
      ...
      env_file: '.env.uat',
      log_file: './logs/account-deletion-uat-combined.log',
      out_file: './logs/account-deletion-uat-out.log',
      error_file: './logs/account-deletion-uat-error.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      watch: false,
      autorestart: true,
      max_memory_restart: '256M',
    ...
    {
      name: 'tc-delivery-news-publication-prod',
      version: APP_VERSION,
      script: 'dist/cronjob/process-news-publication.cronjob.js',
      cwd: './',
      instances: 1,
      ...
      env_file: '.env.production',
      log_file: './logs/news-publication-prod-combined.log',
      out_file: './logs/news-publication-prod-out.log',
      error_file: './logs/news-publication-prod-error.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      watch: false,
      autorestart: true,
      max_memory_restart: '256M',
    ...
    {
      name: 'tc-delivery-account-deletion-prod',
      version: APP_VERSION,
      script: 'dist/cronjob/process-account-deletion.cronjob.js',
      cwd: './',
      instances: 1,
      ...
      env_file: '.env.production',
      log_file: './logs/account-deletion-prod-combined.log',
      out_file: './logs/account-deletion-prod-out.log',
      error_file: './logs/account-deletion-prod-error.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      watch: false,
      autorestart: true,
      max_memory_restart: '256M',
